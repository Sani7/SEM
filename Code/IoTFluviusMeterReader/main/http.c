...
void publish_received_data(fluviusData data, http_server_info info)
{
    ...
    char http_url[50];
    sprintf(http_url, "%s:%d/%s", info.ip, info.port, info.uri);

    char post_data[500]; // The request will be build in this String
    sprintf(post_data, "api_key=%s&UL1=%5.1f&UL2=%5.1f&UL3=%5.1f \
            &IL1=%5.1f&IL2=%5.1f&IL3=%5.1f&Pcl=%10.3f&Pch=%10.3f \
            &Ppl=%10.3f&Pph=%10.3f&Pc=%6.3f&Pp=%6.3f&Vg=%10.3f&Vw=%10.3f",
    ...
    // POST
    esp_http_client_set_url(client, http_url);
